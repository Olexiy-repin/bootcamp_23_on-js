...
import createGalleryCard from '../templates/heroes.hbs';
...
const heroesGalleryEl = document.querySelector('.js-heroes-list');

heroesGalleryEl.innerHTML = createGalleryCard(heroesDb);
